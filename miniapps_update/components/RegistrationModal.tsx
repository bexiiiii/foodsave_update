  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center gap-2 pt-12 pb-2">
        <div className={`h-1.5 rounded-full transition-all duration-300 ${step === 1 ? 'w-6 bg-[#4CAD73]' : 'w-3 bg-[#4CAD73]/40'}`} />
        <div className={`h-1.5 rounded-full transition-all duration-300 ${step === 2 ? 'w-6 bg-[#4CAD73]' : 'w-3 bg-[#4CAD73]/40'}`} />
      </div>
        ...
        <div className="flex flex-col flex-1 px-6 pt-8">
          ...
          <div className="mt-auto pb-8 pt-6">
            <button
              ...
              className="w-full h-14 bg-[#4CAD73] disabled:bg-gray-200 disabled:text-gray-400 text-white text-base font-semibold font-inter rounded-2xl transition-all active:scale-95 shadow-sm"
            >
              Далее
            </button>
          </div>
        ...
        <div className="flex flex-col flex-1 px-6 pt-8">
          <div className="flex justify-center mb-6">
            <div className="w-20 h-20 bg-gray-100 rounded-2xl flex items-center justify-center">
              <svg className="w-10 h-10 text-[#4CAD73]" viewBox="0 0 24 24" fill="none" stroke="currentColor">
